...
class Settings(BaseSettings):
    ...
    bank_interest_rate_mid_per_interval: float = 0.0275
    bank_interest_rate_high_per_interval: float = 0.03
    bank_interest_rate_low_balance_max: float = 500.0
    bank_interest_rate_mid_balance_max: float = 1000.0
    bank_interest_interval_hours: float = 120.0
    bank_max_borrow_absolute: float = 1500.0
    bank_max_borrow_net_worth_ratio: float = 0.15
    bank_base_credit_limit: float = 300.0
